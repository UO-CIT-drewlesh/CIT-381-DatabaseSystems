...
-- -----------------------------------------------------
-- Data for table `alumni`.`AlumniMembers`
-- -----------------------------------------------------
START TRANSACTION;
USE `alumni`;
INSERT INTO `alumni`.`AlumniMembers` (`AlumID`, `RegisterID`, `PathwayID`, `AlumFirstName`, `AlumLastName`, `AlumPhoneNumber`, `AlumGradYear`) VALUES (1, 1, 3, 'Larry', 'Lobster', '100-100-1000', '1999');
INSERT INTO `alumni`.`AlumniMembers` (`AlumID`, `RegisterID`, `PathwayID`, `AlumFirstName`, `AlumLastName`, `AlumPhoneNumber`, `AlumGradYear`) VALUES (2, 2, 2, 'Spongbob', 'Squarepants', '110-110-1100', '2002');
INSERT INTO `alumni`.`AlumniMembers` (`AlumID`, `RegisterID`, `PathwayID`, `AlumFirstName`, `AlumLastName`, `AlumPhoneNumber`, `AlumGradYear`) VALUES (3, 3, 8, 'Gary', 'Snail', '111-111-1111', '2009');
INSERT INTO `alumni`.`AlumniMembers` (`AlumID`, `RegisterID`, `PathwayID`, `AlumFirstName`, `AlumLastName`, `AlumPhoneNumber`, `AlumGradYear`) VALUES (4, 4, 9, 'Squidward', 'Tentacles', '121-212-2112', '1995');
INSERT INTO `alumni`.`AlumniMembers` (`AlumID`, `RegisterID`, `PathwayID`, `AlumFirstName`, `AlumLastName`, `AlumPhoneNumber`, `AlumGradYear`) VALUES (5, 5, 4, 'Peter', 'Parker', '651-282-1293', '2007');
